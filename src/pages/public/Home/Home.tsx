      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
        ...
        <section className="justify-around py-6 px-4 flex w-full flex-col md:flex-row max-md:gap-6">
          <div className="container text-center w-full md:w-[55%] flex items-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="max-md:hidden text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 leading-relaxed px-4">
                Transforme momentos especiais em experiências digitais únicas.
                Personalize um cartão exclusivo para surpreender, emocionar e
                encantar quem você ama, criando uma lembrança inesquecível.
              </p>
          ...
          <div className="self-center w-[70%] max-sm:w-[200px] md:w-[25%] lg:w-[20%] py-4">
            <img
              className="rotate-[-15deg] rounded-2xl w-full h-full"
              src="imagens/imagem5home.jpg"
            />
          </div>
        ...
        <section className="hidden sm:flex sm:flex-col py-8 justify-center items-center">
          <h3 className="sm:max-w-[60%] sm:text-4xl font-bold text-center text-gray-800 mb-8 sm:mb-12">
            Veja o passo a passo de como
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
              {" "}
              criar sua WebPage
            </span>
        ...
        <section className="sm:hidden py-10 flex flex-col sm:flex-row gap-2 justify-center items-center">
          <h3 className="sm:max-w-[30%] text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-8 sm:mb-12">
            Veja o passo a passo de como
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
              {" "}
              criar sua WebPage
          ...
          <video
            width="240"
            height="100"
            controls // mostra os botões de play/pause, volume, etc.
            autoPlay={false} // se quiser que comece automaticamente, troque para true
            muted={false} // se estiver com autoplay, precisa ser muted=true
            loop // se quiser que o vídeo reinicie automaticamente
          >
            <source src="./videos/tutorial-criacao.mp4" type="video/mp4" />
